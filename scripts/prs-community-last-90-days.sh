...
COMMUNITY_PRS_MERGED_PERCENTAGE_CHANGE=$(bc <<< "scale=1; ($COMMUNITY_PRS_MERGED_LAST_90_DAYS-$COMMUNITY_PRS_MERGED_PREV_90_DAYS)/$COMMUNITY_PRS_MERGED_PREV_90_DAYS * 100")
